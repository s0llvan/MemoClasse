...
correctPath = null;
    ...
    constructor(public navParams: NavParams, private base64: Base64, public navCtrl: NavController, public plt: Platform, private file: File, private fileOpener: FileOpener,private toastCtrl: ToastController,private emailComposer: EmailComposer,private dataProvider: DataProvider)
    {
...
sendMail() {
  this.correctPath = "" + this.file.dataDirectory + 'rapportEleve.pdf';
    let email = {
        to: this.student.mails[0],

          attachments: ['' +this.file.dataDirectory.replace('file://','') + "rapportEleve.pdf"],
